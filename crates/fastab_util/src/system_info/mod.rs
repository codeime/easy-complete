...
pub fn is_remote() -> bool {
    ...
    in_ssh() || in_cloudshell() || in_wsl() || fastab_os_shim::Env::new().q_fake_is_remote()
}
...
pub fn has_parent() -> bool {
    ...
    *HAS_PARENT.get_or_init(|| fastab_os_shim::Env::new().has_q_parent())
}
...
pub fn in_codespaces() -> bool {
    ...
    *IN_CODESPACES.get_or_init(|| fastab_os_shim::Env::new().in_codespaces())
}

pub fn in_ci() -> bool {
    static IN_CI: OnceLock<bool> = OnceLock::new();
    *IN_CI.get_or_init(|| fastab_os_shim::Env::new().in_ci())
}
