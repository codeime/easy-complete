...
/// Spawns a local unix socket for communicating with fastabterm on a local machine
pub async fn spawn_fastabterm_ipc(
    ...
    let socket_path = directories::fastabterm_socket_path(session_id)?;
