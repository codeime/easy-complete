...
pub struct DesktopHost {
    ...
    pub fastabterm_state: Arc<FigtermState>,
    ...
    pub fn dispatch(&mut self, event: Event, cx: &mut App) {
        match event {
            ...
            Event::GpuiOverlayBuffer {
                ...
                self.overlay
                    .complete_buffer(buffer, cwd, cursor, session_id, self.fastabterm_state.clone(), cx);
            },
            ...
            Event::AutocompleteAction { action, session_id } => {
                self.overlay
                    .handle_action(&action, session_id, &self.fastabterm_state, cx);
            },
            Event::AutocompleteClick {
                ...
                self.overlay
                    .handle_click(click, session_id, generation, &self.fastabterm_state, cx);
            },
        }
    }
